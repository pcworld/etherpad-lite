 ...
 *
 * @param {TODO readonly allowed?} padID identifies the pad the user wants to access.
...
exports.checkAccess = async (padID, sessionCookie, token, userSettings) => {
  ...
  if (settings.loadTest) {
    ...
    //~ if (readOnlyManager.isReadOnlyId(padID)) {
      //~ // pad is read-only, first get the real pad ID; some callers of checkAccess() first fetch the real pad ID,
      //~ // but some do not
